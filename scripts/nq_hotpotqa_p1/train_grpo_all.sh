...
export EXPERIMENT_NAME=${data_name}-search-p1-grpo-qwen2.5-3b-it-em-plan-format-trackb-observe-10steps
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_format \
    ...
    reward_model.trajectory_dump_path=logs/my-trajectories-100.jsonl \
    reward_model.trajectory_dump_limit=120000 \
    max_turns=4 \
    retriever.url="http://127.0.0.1:8000/retrieve" \
    retriever.topk=3 \
    2>&1 | tee logs/$EXPERIMENT_NAME-trackb.log