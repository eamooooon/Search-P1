...
export EXPERIMENT_NAME=${data_name}-search-p1-ppo-qwen2.5-3b-it-em-plan-format
# export BASE_MODEL='models/Qwen2.5-7B'
# export EXPERIMENT_NAME=${data_name}-search-p1-ppo-qwen2.5-7b-em-plan-format
# export BASE_MODEL='models/Qwen2.5-7B-Instruct'
# export EXPERIMENT_NAME=${data_name}-search-p1-ppo-qwen2.5-7b-it-em-plan-format
