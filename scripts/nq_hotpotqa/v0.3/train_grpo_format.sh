...
export EXPERIMENT_NAME=${data_name}-search-r1-grpo-qwen2.5-3b-it-em-structureformat-v0.3
export TRAJECTORY_DUMP_PATH=logs/$EXPERIMENT_NAME.jsonl
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_format \
    ...
    reward_model.trajectory_dump_limit=-1 \
    max_turns=4 \
