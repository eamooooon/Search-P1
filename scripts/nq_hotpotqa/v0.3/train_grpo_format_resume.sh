...
export DATA_DIR=${DATA_DIR:-data/${data_name}} # first download the data from https://huggingface.co/datasets/PeterJinGo/nq_hotpotqa_train
...
export EXPERIMENT_NAME=${EXPERIMENT_NAME:-${data_name}-search-r1-grpo-qwen2.5-3b-it-em-structureformat-v0.3}
...
export RESUME_PATH=${RESUME_PATH:-checkpoints/$EXPERIMENT_NAME}
export SWANLAB_RESUME=${SWANLAB_RESUME:-must}
export SWANLAB_RUN_ID=${SWANLAB_RUN_ID:-}
